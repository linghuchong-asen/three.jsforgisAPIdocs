<template><div><h1 id="共面多边形-coplanarpolygongeometry" tabindex="-1"><a class="header-anchor" href="#共面多边形-coplanarpolygongeometry" aria-hidden="true">#</a> 共面多边形(CoplanarPolygonGeometry)</h1>
<p>由任意共面位置组成的多边形</p>
<h2 id="构造器" tabindex="-1"><a class="header-anchor" href="#构造器" aria-hidden="true">#</a> 构造器</h2>
<p><strong>CoplanarPolygonGeometry(options)</strong></p>
<p>options具有以下属性</p>
<table>
<thead>
<tr>
...
<td style="text-align:left"><a href="https://cesium.com/learn/cesiumjs/ref-doc/PolygonHierarchy.html" target="_blank" rel="noopener noreferrer">PolygonHierarchy<ExternalLinkIcon/></a></td>
...
<td style="text-align:left"><code v-pre>optional</code>纹理坐标的旋转，以弧度为单位。正的旋转是逆时针的。</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>vertexFormat</code></td>
<td style="text-align:left"><a href="https://cesium.com/learn/cesiumjs/ref-doc/VertexFormat.html" target="_blank" rel="noopener noreferrer">VertexFormat<ExternalLinkIcon/></a></td>
<td style="text-align:left"><code v-pre>VertexFormat.DEFAULT</code></td>
<td style="text-align:left"><code v-pre>optional</code>纹理坐标的旋转，以弧度为单位。正的旋转是逆时针的。</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>ellipsoid</code></td>
<td style="text-align:left"><a href="https://cesium.com/learn/cesiumjs/ref-doc/Ellipsoid.html" target="_blank" rel="noopener noreferrer">Ellipsoid<ExternalLinkIcon/></a></td>
<td style="text-align:left"><code v-pre>Ellipsoid.WGS84</code></td>
<td style="text-align:left"><code v-pre>optional</code>要计算的顶点属性。</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>textureCoordinates</code></td>
<td style="text-align:left"><a href="https://cesium.com/learn/cesiumjs/ref-doc/PolygonHierarchy.html" target="_blank" rel="noopener noreferrer">PolygonHierarchy<ExternalLinkIcon/></a></td>
<td style="text-align:left"></td>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> polygonGeometry <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Cesium<span class="token punctuation">.</span>CoplanarPolygonGeometry</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
...
<p><strong><a href="">fromPositions(options) → CoplanarPolygonGeometry</a></strong></p>

<template><div><h1 id="仅有轮廓的墙-walloutlinegeometry" tabindex="-1"><a class="header-anchor" href="#仅有轮廓的墙-walloutlinegeometry" aria-hidden="true">#</a> 仅有轮廓的墙(WallOutlineGeometry)</h1>
<p>对墙的轮廓的描述。墙是由一系列的点构成的，这些点向下延伸到地面。 可选地，它们可以向下挤压到指定的高度。</p>
<h2 id="构造器" tabindex="-1"><a class="header-anchor" href="#构造器" aria-hidden="true">#</a> 构造器</h2>
<p><strong>WallOutlineGeometry(options)</strong></p>
...
<td style="text-align:left">笛卡尔对象数组，它们是墙的点。</td>
</tr>
<tr>
...
<td style="text-align:left">optional每个经度和纬度之间的距离，以弧度表示。确定缓冲区中的位置数。</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>maximumHeights</code></td>
<td style="text-align:left">number[ ]</td>
<td style="text-align:left"></td>
<td style="text-align:left">optional与<code v-pre>positions</code>并行的数组，给出了在<code v-pre>positions</code>处墙的最大高度。如果未定义，则使用每个位置的高度。</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>minimumHeights</code></td>
<td style="text-align:left">number[ ]</td>
<td style="text-align:left"></td>
<td style="text-align:left">optional与<code v-pre>positions</code>并行的数组，给出了在<code v-pre>positions</code>处墙的最小高度。如果未定义，则每个位置的高度为0.0。</td>
</tr>
<tr>
...
<td style="text-align:left">optional用于坐标操作的椭球体。</td>
</tr>
</tbody>
</table>
<h2 id="示例代码" tabindex="-1"><a class="header-anchor" href="#示例代码" aria-hidden="true">#</a> 示例代码</h2>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 创建一个从地面到10000米的墙的轮廓</span>
<span class="token keyword">var</span> wall <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Webgis<span class="token punctuation">.</span>WallOutlineGeometry</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
...
<span class="token keyword">var</span> geometry <span class="token operator">=</span> Webgis<span class="token punctuation">.</span>WallOutlineGeometry<span class="token punctuation">.</span><span class="token function">createGeometry</span><span class="token punctuation">(</span>wall<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<p><code v-pre>static</code> <strong><a href="">fromConstantHeights(options): WallOutlineGeometry</a></strong></p>
<p>对墙的轮廓的描述。墙是由一系列的点构成的，这些点向下延伸到地面。 可选地，它们可以向下挤压到指定的高度。</p>
<p>options对象，具有以下属性：</p>
<table>
<thead>
...
<tr>
<td style="text-align:left"><code v-pre>maximumHeight</code></td>
<td style="text-align:left">Number</td>
<td style="text-align:left"></td>
<td style="text-align:left">optional与<code v-pre>positions</code>并行的数组，给出了在<code v-pre>positions</code>处墙的最大高度。如果未定义，则使用每个位置的高度。</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>minimumHeight</code></td>
<td style="text-align:left">Number</td>
<td style="text-align:left"></td>
<td style="text-align:left">optional与<code v-pre>positions</code>并行的数组，给出了在<code v-pre>positions</code>处墙的最小高度。如果未定义，则每个位置的高度为0.0。</td>
</tr>
...
<h5 id="example" tabindex="-1"><a class="header-anchor" href="#example" aria-hidden="true">#</a> Example:</h5>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 建造一堵从10000米到20000米的墙</span>
<span class="token keyword">var</span> wall <span class="token operator">=</span> Webgis<span class="token punctuation">.</span>WallOutlineGeometry<span class="token punctuation">.</span><span class="token function">fromConstantHeights</span><span class="token punctuation">(</span><span class="token punctuation">{</span>

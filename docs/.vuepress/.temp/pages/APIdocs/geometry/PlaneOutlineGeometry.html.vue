<template><div><h1 id="仅有轮廓平面-planeoutlinegeometry" tabindex="-1"><a class="header-anchor" href="#仅有轮廓平面-planeoutlinegeometry" aria-hidden="true">#</a> 仅有轮廓平面(PlaneOutlineGeometry)</h1>
<p>描述以原点为中心、具有单位宽度和长度的平面轮廓的几何图形。</p>
